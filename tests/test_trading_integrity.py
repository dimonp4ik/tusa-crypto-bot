...
class ExchangeTests(unittest.TestCase):
    ...
    def test_live_entry_uses_capped_exchange_backstop_risk(self):
        from src import autotrader as at
        ...
        backstop=2*max(1,at.STOP_EXCHANGE_BACKSTOP_R) if at.STOP_CLOSE_CONFIRM else 2
        self.assertLessEqual(quantity*(backstop+100*at.AUTOTRADE_COST_RESERVE),128*at.AUTOTRADE_RISK_PER_TRADE)
