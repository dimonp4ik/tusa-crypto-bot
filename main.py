...
def _deep_feed_breached(symbol: str, sl: float, direction: str,
    ...
    exists in three places in this project; it does not need a fourth.
...
def _check_open_signals():
    ...
    for sig in active_signals:
        try:
            ...
            # Default off -- see STOP_REQUIRE_GLOBAL_CONFIRM in config.py for the
            # measured share of X-Perp-only stops and the risk of holding on.
            _deep_ok = None
