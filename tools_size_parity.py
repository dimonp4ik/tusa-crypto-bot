...
def main_() -> int:
    ...
    sessions = ["LONDON", "NEW_YORK", "OVERLAP", "OFF_HOURS", "DEAD_ZONE", "CLOSE", "OPEN", "MIDDAY"]
    ...
    for _ in range(runs):
        entry = 100.0
        sig = {
            "symbol": random.choice(["BTCUSDT", "ETHUSDT", "SOLUSDT", "PEPEUSDT"]),
        ...
        # be there.
        model = bt._size_mult_for(sig["symbol"], sig)
